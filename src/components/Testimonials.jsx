...
const reviews = [
  { name: 'Aarav S.', role: 'Mobile App Developer', rating: 5, date: 'April 2026',
    text: 'Best Flutter course I\'ve taken. Went from knowing nothing about Dart to building cross-platform apps on iOS & Android.' },
  { name: 'Megha R.', role: 'Software Intern', rating: 5, date: 'March 2026',
    text: 'The 40-hour live curriculum is structured beautifully. The Firebase integration and Material UI modules are exceptional.' },
  { name: 'Nikhil K.', role: 'Cross-Platform Engineer', rating: 4, date: 'February 2026',
    text: 'Very practical and hands-on. Every concept has live code demonstrations and Pankaj Sir resolves all doubts patiently.' },
]
