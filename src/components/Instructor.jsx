...
const expertise = [
  'Mobile: Dart Programming, Flutter SDK, Cross-Platform iOS & Android',
  'UI & Layouts: Google Material UI, Cupertino Widgets, Responsive Layouts',
  'Backend & Cloud: REST API Integration, Firebase Auth, Firestore Database',
  'Local Storage & Tools: SQLite, SharedPreferences, pub.dev packages, VS Code, Android Studio',
  'Modern Dev Workflow: Git, GitHub, Postman, API Testing, App Deployment',
  'Generative AI & Agentic AI: OpenAI, Gemini, Claude, Prompt Engineering, AI Mobile Agents'
]
        ...
        <div className="mt-8 rounded-3xl border border-gray-200 bg-white p-6 shadow-[0_20px_70px_-48px_rgba(15,23,42,0.32)] sm:p-8">
          <div className="grid gap-7 lg:grid-cols-[220px_1fr] lg:items-start">
            <div className="rounded-2xl border border-gray-200 bg-white p-5 text-center shadow-sm">
              ...
              <p className="mt-1 text-sm font-semibold text-indigo-700">Workshop Host & Mentor</p>
              ...
              <div className="mt-5 space-y-2 text-left text-xs sm:text-sm">
                ...
                <div className="flex items-center gap-2 rounded-lg border border-gray-200 bg-gray-50 px-3 py-2 text-gray-700">
                  ...
                  <span>Hands-on Live Building</span>
                </div>
              </div>
            </div>
            ...
            <div>
              ...
              <p className="mt-4 text-sm leading-7 text-gray-600 sm:text-base">
                Pankaj brings over 15 years of industry experience training freshers and working professionals in Mobile Systems and Software Architecture. His masterclass style is 100% practical, project-driven, and focused on helping attendees build and launch real cross-platform mobile apps using Flutter & Dart.
              </p>
